...
private:
	...
	// Added for maintainability and to clean up PrepareScene
	...
	// define the material properties used by the scene lighting
	void DefineObjectMaterials();

	// configure the light sources used in the 3D scene
...
public:
	...
	// Methods for rendering the individual objects in the scene
	void RenderToolCaddy();
	void Render3DPrinter();
	void RenderFilamentSpool();
	void Render3DPrintedPart();
};